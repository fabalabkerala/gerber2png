...
export const  PageLayout = ({ sidebar, main, right }) => {
    ...
    return (
        <>
            <div className="h-full relative flex flex-col md:flex-row bg-slate-100 transition-colors dark:bg-[#081018] md:overflow-hidden">
                ...
                <AnimatePresence>
                    {loader && (
                        <motion.div
                            ...
                            className="absolute inset-0 bg-white/40 backdrop-blur-sm flex items-center justify-center z-[9999] dark:bg-slate-950/50"
                        >
                            <motion.div
